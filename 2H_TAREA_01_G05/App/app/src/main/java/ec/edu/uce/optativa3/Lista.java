...
public class Lista extends AppCompatActivity {
    ...
    public void Listar(){
        ...
        Cursor fila = BaseDatos.rawQuery("select id,nombre from ESTUDIANTES ",null);
        ...
        if(fila.moveToFirst()) {
            ...
            do{
                TableRow row = new TableRow(getBaseContext());
                    ...
                    textView.setText(" "+fila.getString(0)+" "+fila.getString(1));
        ...
        String nn= idEstudiante.getText().toString();
            ...
            if(!nn.isEmpty()) {
                ...
                Cursor fila = BaseDatos.rawQuery("select nombre,apellido,email,celular,genero,fecha,asignaturas,becado " +
